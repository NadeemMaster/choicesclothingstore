    ...
    <div class="modal-content">
        ...
        <form wire:submit.prevent="updateDelivery">
            <div class="modal-body">
                ...
                <input wire:model.defer="deliverydate" type="date" class="form-control" placeholder="Select delivery date" />
                ...
                <br>
                    <h6 class="py-5">Order delivered successfully!</h6>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">No</button>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <a href="{{ url()->previous() }}" class="btn btn-primary float-end text-white mx-2">Back</a>
                            ...
                            @foreach ($order->orderItems as $orderitem)
                                <tr>
                                    ...
                                    <td width="15%" class="fw-bold">
                                        {{ 'Rs.' . $orderitem->price * $orderitem->quantity . '/-' }}</td>
                                    @php
